...
public class HelloTraceV2 {
    ...
    private static final String START_PREIFX = "-->";
    ...
    public TraceStatus begin(String message) {
        ...
        //로그 출력
        log.info("[{}] {}{}", traceId.getId(), addSpace(START_PREIFX, traceId.getLevel()), message);
    ...
    public TraceStatus beginSync(TraceId beforeTraceId, String message) {
        ...
        long startTimeMs = System.currentTimeMillis();
        //로그 출력
        log.info("[{}] {}{}", nextId.getId(), addSpace(START_PREIFX, nextId.getLevel()), message);
